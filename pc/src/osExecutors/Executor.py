...
from pc.src.osExecutors.LinuxExecutor import LinuxExe
from pc.src.osExecutors.MacExecutor import MacExe
from pc.src.osExecutors.WindowsExecutor import WinExe
