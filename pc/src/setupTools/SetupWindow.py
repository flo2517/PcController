...
from pc.src.setupTools.ChangePasswordWindow import ChangePassword
from pc.src.setupTools.CreditsWindow import Credits
from pc.src.setupTools.DelAcountWindow import DelAccount
